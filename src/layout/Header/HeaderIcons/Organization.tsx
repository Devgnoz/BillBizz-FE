            ...
            <div key={index} className="flex items-center border border-slate-200 p-4 rounded-md shadow-sm">
             ...
             <OrganizationIcon/>
              ...
              <div className="flex-grow">
                ...
                <p className="text-xs text-gray-700">Organization ID: 43434659883</p>
              </div>
              <div className="flex items-center">
                <span className="text-xs bg-yellow-100 border text-yellow-800 py-1 px-2 rounded-2xl pl-2 pr-2">Trail</span>
              </div>
              <div className="ml-24">
                <input type="radio" name="selectedBranch" className="h-4 w-4" />
              </div>
            </div>
          ))}
        </div>

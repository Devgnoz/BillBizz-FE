        ...
        <div className="p-4">
          <div className="space-y-4">
            <div className="p-4 flex border border-slate-200 rounded-md shadow-sm">
              ...
              <div className="flex-grow">
                ...
                <p className="text-xs text-gray-700">
                  Item [Product Name] is now out of stock. Please restock as
                  soon as possible.
                </p>
            ...
            <div className="p-4 flex border border-slate-200 rounded-md shadow-sm">
              <div className="mr-4">
                <img
                  src="https://s3-alpha-sig.figma.com/img/0404/8874/bcd210f64cacfe712297b84b5ccf2167?Expires=1721001600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mBdMeWe1phM64aftLfzxKOYCg2KGgQjPoKJTI1smGDxpMcTLhWXPMonvASd1JhFtAWR9zoF6GqUrTemShPT6RGMfnPMvHnp6ODxOj8--MoIJcyRe0Pn17Ijs9m9urHqnyRiK2NI~QxLHsa~KMW2bjZvI4pbl4uitBLIguGTwcOPW7Z3HzL030~SsS1HDk1k6sbW~avAF7qa0sYSEaQ-HvlKwGNEswRP~ynxId2JgBxGhfs2qmiMAhIEbF-8lb9OFfvalfn8OafYUHY7~enUEXNH6wl1d4I5wx5H3~qEmvOFCBXbliNt9zIX2-myD2H48D~LrtL~5MB29NR0SaVZD7w__"
                  alt=""
                  className="h-[40px] w-[50px]"
                  style={{ borderRadius: "50%", objectFit: "cover" }}
                />

                ...
                <div className="bg-white drop-shadow-2xl w-[595px]  p-8 pl-[24px] pr-[24px]">
                    <div className="flex justify-between items-center mb-8 mt-1">
                        ...
                        <div className="text-right">
                            <h2 className="text-xl font-bold text-textColor">SALES ORDER</h2>
                            <p className="text-sm font-bold text-dropdownText mt-[5px]">Sales Order# Dp-00002</p>

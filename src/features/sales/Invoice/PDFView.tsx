        ...
        <div className="bg-white drop-shadow-2xl w-[595px]  p-8 pl-[24px] pr-[24px]">
            <div className="flex justify-between items-center mb-8 mt-1">
                ...
                <div className="text-right">
                    <h2 className="text-xl font-bold text-textColor">TAX INVOICE</h2>
                    <p className="text-sm font-bold text-dropdownText mt-[5px]">Invoice# INV-00002</p>
            ...
            <div className="flex gap-12">
                ...
                <h3 className="font-normal text-xs text-pdftext">Bill to</h3>
                <p className="text-pdftext text-sm font-bold mt-2">Smart world</p>
                <p className="font-normal text-xs text-pdftext mt-2">Order Date: 24/06/2024</p>
                <p className="font-normal text-xs text-pdftext mt-2">Expected shipment Date:24/06/2024</p>
                </div>
            </div>

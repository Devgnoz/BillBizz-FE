        ...
        <div className="mt-4">
            ...
            <div className="mt-4 bg-cuscolumnbg p-4 rounded-lg flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm font-normal text-dropdownText  mt-2">Purchase order has been created. You can email the Purchase Order to your customer or mark it as Confirmed.</p>
                </div>

...
const CustomiseQuoteTable = ({ columns, setColumns }: Props) => {
    ...
    <>
      ...
      >
        <div className="p-5">
          ...
          <SearchBar onSearchChange={setSearchValue} searchValue={searchValue} placeholder="Search Sales Quote" />
          <div>
...
export default CustomiseQuoteTable;

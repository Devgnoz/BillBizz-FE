  ...
  return (
    ...
    <>
            <div className="p-5 mt-3">
              ...
              <form className="text-slate-600 text-sm overflow-scroll hide-scrollbar space-y-5"  style={{ height: "480px" }}>
                <label htmlFor="">
                  Cutomer Type <br />
      ...
      <ul className="h-full   space-y-0 border-gray-300 text-slate-700">
        <li
          className={`${getTabClassName('otherDetails')} border-r-4 ${getBorderClassName('otherDetails')} p-2 `}
          onClick={() => setActiveTab('otherDetails')}
        >
          Other Details
        </li>
        <li
          className={`${getTabClassName('address')} border-r-4 ${getBorderClassName('address')} p-2`}
          onClick={() => setActiveTab('address')}
        >
          Address
        </li>
        <li
          className={`${getTabClassName('contactPersons')} border-r-4 ${getBorderClassName('contactPersons')} p-2`}
          onClick={() => setActiveTab('contactPersons')}
        >
          Contact Persons
        </li>
        <li
          className={`${getTabClassName('customFields1')} border-r-4 ${getBorderClassName('customFields1')} p-2`}
        //   onClick={() => setActiveTab('customFields1')}
        >
          Custom fields
        </li>
        <li
          className={`${getTabClassName('customFields2')} border-r-4 ${getBorderClassName('customFields2')} p-2`}

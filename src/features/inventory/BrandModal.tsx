      ...
      <Modal open={true} onClose={onClose} className="w-[66%]">
        <div className="p-5 mt-3">
          <div className="mb-5 flex p-4 rounded-xl bg-CreamBg relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-dropdownText font-semibold text-sm mt-2">
                Have an insight on the profit or loss incurred due to the change in <br /> exchange rates
              </p>
            </div>
          ...
          <div className="flex justify-end pr-3">
            <Button onClick={openAddModal} variant="secondary" size="lg" style={{ height: "38px", padding: "14px" }}>

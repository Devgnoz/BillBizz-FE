    ...
    return (
        <div className="mt-4">
            <div className="flex items-center justify-start mb-4">
                <p className="text-textColor border-r-[1px]  pr-4 border-borderRight text-sm font-normal">
                    Bill Date: <span className="ms-3 text-dropdownText text-sm font-semibold">24/06/2024</span>
                </p>
                <p className="text-textColor border-r-[1px]  pr-4 pl-4 text-sm font-normal">
                    Due Date: <span className="ms-3 text-dropdownText text-sm font-semibold">28/06/2024</span>
                </p>
                <p className="text-textColor pl-4 text-sm font-normal">
                    Payment Terms: <span className="ms-3 text-dropdownText text-sm font-semibold">Due On Receipt</span>
                </p>
            </div>
            ...
            <div className="flex items-center justify-between gap-6 mt-6">
                <div className="p-6 rounded-lg border border-billingBorder w-[50%]">
                    <p className="text-base font-bold text-textColor">Supplier Address</p>
